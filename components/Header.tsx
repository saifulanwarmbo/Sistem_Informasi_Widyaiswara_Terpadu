...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
  ...
  return (
    <header className="print:hidden bg-white shadow-sm h-20 flex items-center justify-between px-6 relative z-20">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3">
            <img src={logoLan} alt="Logo LAN RI" fetchPriority="high" loading="eager" className="h-10 w-auto object-contain md:hidden" />
